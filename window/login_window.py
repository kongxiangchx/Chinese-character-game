...
class Ui_login_window(object):
    def setupUi(self, login_window):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(190, 90, 391, 151))
    ...
    def retranslateUi(self, login_window):
        ...
        login_window.setWindowTitle(_translate("login_window", "汉字天地"))
